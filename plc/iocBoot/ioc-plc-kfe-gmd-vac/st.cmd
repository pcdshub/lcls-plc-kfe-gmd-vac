...
epicsEnvSet("ENGINEER", "mghaly" )
epicsEnvSet("LOCATION", "IOC:PLC:KFE:GMD:VAC" )
...
dbLoadRecords("iocSoft.db", "IOC=IOC:PLC:KFE:GMD:VAC")
dbLoadRecords("save_restoreStatus.db", "P=IOC:PLC:KFE:GMD:VAC:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=IOC:PLC:KFE:GMD:VAC")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=IOC:PLC:KFE:GMD:VAC")
...
save_restoreSet_status_prefix( "IOC:PLC:KFE:GMD:VAC:" )
